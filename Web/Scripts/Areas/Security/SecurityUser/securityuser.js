       ...
       $.ajax({
            ...
            success: function (data) {
                ...
                if (data.result) {
                    ...
                    if (flagEdit) alertify.dialog('alert').set({ transition: 'zoom', message: 'Se modificó correctamente el usuario.', title: 'COTIZADOR' }).show();
                    else alertify.dialog('alert').set({ transition: 'zoom', message: 'Se guardo correctamente el usuario.', title: 'COTIZADOR' }).show();
                    ...
                    alertify.dialog('alert').set({ transition: 'zoom', message: 'Se presentaron errores al momento de guardar al usuario.', title: 'COTIZADOR' }).show();
                    return false;
                }
